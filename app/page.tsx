          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
            ...
            <div className="p-6">
              ...
              <input
                ...
                className="w-full px-4 py-2 text-zinc-950 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
